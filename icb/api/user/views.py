...
from ..dashboard.models import TBL_DASHBOARD_ITEM, TBL_DASHBOARDS
from ..role.models import TBL_ROLE, TBL_ROLE_MODULE
...
class USER_CRUD_API(CRUDAPI):
    ...
    def get_header(self):
        return [
            ...
            {"field": "", "concat": [{"field": "first_name"}, {"field": "last_name"}], "label": "full_name", "text": "Full Name"},
            {"field": "email", "text": "Email"},
            {"field": "username", "text": "Username"},
            # {'field': 'gender', "text":"Gender"},
            # {"field": "description", "text": "Gender Name", "model": TBL_GENDER, "label": "gender_name"},
            {"field": "phone", "text": "Phone Number"},
            # {"field": "date_of_birth", "text": "Date of Birth"},
            ...
            # {"field": "employee_id", "text": "Employee ID"},
            # {"field": "", "concat": [{"field": "first_name", "model": TBL_EMPLOYEE},{"field": "last_name", "model": TBL_EMPLOYEE}], "label": "employee_name", "text": "Employee Name"},
            # {"field": "status", "text": "Status"},
            {"field": "name", "model": TBL_ROLE, "label": "role_name", "text": "Role Name"},
            {"field": "name_lc", "model": TBL_ROLE, "label": "role_name_lc", "text": "Role Name (Local)"},
        ]
...
async def read_users_me(
    ...
    data = {
        ...
        'role'           : role,
        'roles'          : jsonable_encoder(roleObj),
        'access_branches': jsonable_encoder(branches),
