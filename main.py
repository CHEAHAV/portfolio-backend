...
_icb_get_lang = core_lib.get_lang

def _safe_get_lang(key, params=None, lang='en', path='icb.'):
    lang = lang or 'en'
    if lang == 'km':
        lang = 'kh'

    try:
        return _icb_get_lang(key, params=params, lang=lang, path=path)
    except ModuleNotFoundError:
        return _icb_get_lang(key, params=params, lang='en', path=path)
